...
public class Opdr10_2RE extends Applet {
    ...
    class VeldListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (getal1 > getal2) {
                tekst = "Grootste getal is " + getal1+ " en kleinste getal is" + getal2;
            }
            else {
                tekst = "Grootste getal " + getal2 +"en kleinste getal is" + getal1;
            }
            repaint();
